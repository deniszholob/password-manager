...
type ComponentWithCustomControls = FileTabsComponent; // & {};
...
const meta: Meta<ComponentWithCustomControls> = {
  ...
  component: FileTabsComponent,
  // decorators: [moduleMetadata({ imports: [] }), applicationConfig({ providers: [ importProvidersFrom() ]})],
  parameters: {
    docs: { description: { component: `FileTabs` } },
    // layout: 'fullscreen',
  },
  argTypes: {
    /** === Input Mapping === */
...
export const FileTabs: StoryObj<ComponentWithCustomControls> = {
